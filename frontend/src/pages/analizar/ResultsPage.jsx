...
export default function ResultsPage({ data, onNewAnalysis }) {
  ...
  }[results.gravity?.toLowerCase()] || { bg: "#f1f5f9", color: "#64748b", label: results.gravity || "Desconocida" };
    ...
    >
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-8 pt-4 pb-16">
        ...
        {results.isMedical === false && (
          <div className="rounded-xl p-4 border flex items-center gap-3 mb-6" style={{ background: "#fee2e2", borderColor: "#f87171" }}>
            <span className="text-xl">⚠️</span>
            <p className="text-sm" style={{ color: "#991b1b" }}>
              <strong>Aviso:</strong> La IA ha determinado que esta imagen no parece ser de carácter médico. Los resultados a continuación pueden no ser precisos.
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            <div className="rounded-2xl p-4 border" style={{ background: "rgba(255,255,255,0.9)", borderColor: "#e2e8f0" }}>
              <p className="text-xs font-semibold mb-3" style={{ color: "#94a3b8" }}>IMAGEN EVALUADA</p>
          ...
          <div className="lg:col-span-3 flex flex-col gap-5">
            {/* Confianza */}
            <div className="rounded-2xl p-6 border" style={{ background: "rgba(255,255,255,0.9)", borderColor: "#e2e8f0" }}>
              <ConfidenceMeter value={results.provability} color={accentColor} />
            </div>

            {/* Descripción (Description) */}
            <div className="rounded-2xl p-6 border" style={{ background: "rgba(255,255,255,0.9)", borderColor: "#e2e8f0" }}>
              <p className="text-sm font-bold mb-2" style={{ color: "#0f172a" }}>Descripción Clínica</p>
            ...
            <div className="rounded-2xl p-6 border flex items-start gap-4 shadow-sm" style={{ background: "rgba(240,249,255,0.8)", borderColor: "#bae6fd" }}>
              <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: "#e0f2fe" }}>
              ...
              <div>
                <p className="text-sm font-bold mb-1" style={{ color: "#0369a1" }}>Tratamiento Sugerido</p>
            ...
            {results.compuestos && results.compuestos.length > 0 && (
              <div className="rounded-2xl p-6 border" style={{ background: "rgba(255,255,255,0.9)", borderColor: "#e2e8f0" }}>
                <p className="text-sm font-bold mb-4" style={{ color: "#0f172a" }}>Principios Activos Identificados</p>
                <div className="flex flex-wrap gap-2">
                  {results.compuestos.map((c) => (
                    <span
                      ...
                      style={{ background: "white", color: "#334155", border: "1px solid #e2e8f0", boxShadow: "0 2px 5px rgba(0,0,0,0.02)" }}
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                        <path d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      {c.name}
                    </span>
                  ))}
